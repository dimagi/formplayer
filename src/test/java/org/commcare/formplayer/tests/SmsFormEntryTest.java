...
public class SmsFormEntryTest extends BaseTestClass {
    ...
    public void testOQPS() throws Exception {
        NewFormResponse newSessionResponse = startNewForm("requests/sms/session0/new_form.json",
                "xforms/oqps.xml");
        FormEntryResponseBean formEntryResponseBean =
                answerQuestionGetResult("requests/sms/session0/answer.json",
    ...
    public void testMultipleQuestions() throws Exception {
        NewFormResponse newSessionResponse = startNewForm("requests/sms/session1/new_form.json",
                "xforms/oqps.xml");
        ...
        FormEntryResponseBean formEntryResponseBean =
                answerQuestionGetResult("requests/sms/session1/answer_0.json",
                        newSessionResponse.getSessionId());
        ...
        formEntryResponseBean =
                answerQuestionGetResult("requests/sms/session1/answer_1.json",
                        newSessionResponse.getSessionId());
        assert formEntryResponseBean.getEvent().getType().equals("form-complete");
        assert formEntryResponseBean.getEvent().getIx().equals(">");
    }
    ...
    public void testFieldList() throws Exception {
        NewFormResponse newSessionResponse = startNewForm("requests/sms/session2/new_form.json",
                "xforms/field_list.xml");
        FormEntryResponseBean formEntryResponseBean =
                answerQuestionGetResult("requests/sms/session1/answer_0.json",
                        newSessionResponse.getSessionId());
