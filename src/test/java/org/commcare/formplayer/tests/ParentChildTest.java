...
public class ParentChildTest extends BaseTestClass {
    ...
    public void testParentChild() throws Throwable {
        NewFormResponse newFormResponse = sessionNavigate(new String[]{"0", "0"}, "parentchild",
        ...
        EntityListResponse entityListResponse = sessionNavigate(new String[]{"1"}, "parentchild",
                EntityListResponse.class);
        assertEquals(1, entityListResponse.getEntities().length);
        String entityId = entityListResponse.getEntities()[0].getId();
        entityListResponse = sessionNavigate(new String[]{"1", entityId}, "parentchild",
                EntityListResponse.class);
        assertEquals(1, entityListResponse.getEntities().length);
    }
}
